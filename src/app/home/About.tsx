        ...
        <Grid container alignItems="center">
          ...
          <Grid item md={6} xs={12} className={style.home__about__right}>
            ...
            >
              ...
              profound difference in the lives of individuals with disabilities.
              We understand that each person is unique, and we are committed to
              providing exceptional care and support that is thoughtfully
        ...
        <Grid container alignItems="center">
          ...
          <Grid item md={6} xs={12} className={style.home__about__right}>
            ...
            <Typography
              ...
              className={style.home__about__right__body}
            >
              <span>• Empathy:</span> We approach our work with deep empathy,
              understanding the unique challenges and triumphs of each person we
              assist. <br />
              <span>• Respect:</span> Respect is at the heart of everything we
              do. We respect your choices, your aspirations, and your
              individuality. <br />
              <span>• Dedication:</span> Our team is dedicated to going the
              extra mile, ensuring that you receive the best possible care and
              support. <br />
              <span>• Inclusivity:</span> We champion inclusivity, striving to
              create a world where everyone has equal opportunities to thrive.{" "}
              <br />
              <span>• Quality:</span> We are committed to providing the highest
              quality of service, ensuring your well-being and satisfaction.
            </Typography>
        ...
        <Grid container alignItems="center">
          ...
          >
            ...
            >
              ...
              dedicated professionals who are not only experts in their fields
              but also deeply passionate about their work. They bring expertise,
              compassion, and a genuine desire to make a positive impact in your
              life. We invite you to delve deeper into our world, learn about
              our mission, values, and the incredible individuals who make
              Famous Care what it is today.
            </Typography>
